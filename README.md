...
- Use gradle dependency: `compile 'com.visuality.f32forandroid:f32:2.3.2'`
...
Before making requests for weather forecast, sign up [here](http://openweathermap.org) and get API key (if you don't already have one).
